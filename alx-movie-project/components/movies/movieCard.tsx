...
const MovieCard: React.FC<MovieProps> = ({ id, title, poster_path, vote_average }) => {
    return (
        <div className="w-[168.5px] h-[302px] bg-[#4C3A51] rounded-[10px] mt-4 shadow-inner shadow-[#f1d7de]/15">
            ...
            <Image unoptimized={true} src={poster_path ? `https://image.tmdb.org/t/p/w500${poster_path}` : 'https://placehold.co/30x40/4C3A51/f1d7de?text=No+Img'} alt="movie card" width={151} height={223} className="mt-4" />
            </div>
